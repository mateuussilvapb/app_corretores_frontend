...
import { ContextMenu, MenuItensWithPermissions } from "src/app/shared/context-menu/context-menu";
...
export class ContextMenuCorretores extends ContextMenu<ContextMenuCorretoresData> {
  ...
  protected override menuItems = (data: ContextMenuCorretoresData): MenuItensWithPermissions[] => [
    {
      id: 'visualizar',
      label: 'Visualizar',
      icon: 'pi pi-search',
  ...
  private onExcluir(idString: string) {
    this.confirmationService.confirm({
      message: 'Tem certeza que deseja excluir este corretor? A ação não poderá ser desfeita.',
      header: 'Confirma?',
