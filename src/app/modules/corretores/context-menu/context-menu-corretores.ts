...
export class ContextMenuCorretores extends ContextMenu<ContextMenuCorretoresData> {
  ...
  protected override menuItems = (
  ...
  ): MenuItensWithPermissions[] => [
    {
      ...
      label: 'Visualizar',
      icon: 'pi pi-search',
      url: `${this.baseHref}/corretores/${data.corretor.idString}/visualizar`,
    ...
    },
    {
      ...
      url: `${this.baseHref}/corretores/${data.corretor.idString}/editar`,
      rolesAllowed: [ROLES.ADMIN, ROLES.MANAGER, ROLES.EMPLOYEE],
    },
    {
      id: 'vales',
      label: 'Vales',
      icon: 'pi pi-dollar',
      url: `${this.baseHref}/corretores/${data.corretor.idString}/vales`,
      rolesAllowed: [ROLES.ADMIN, ROLES.MANAGER, ROLES.EMPLOYEE],
    },
    {
      id: 'veiculos',
      label: 'Veículos',
      icon: 'pi pi-car',
      url: `${this.baseHref}/corretores/${data.corretor.idString}/veiculos`,
      rolesAllowed: [ROLES.ADMIN, ROLES.MANAGER, ROLES.EMPLOYEE],
    },
    {
      id: 'excluir',
